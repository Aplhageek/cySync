(function () {
  ...
  window.onMnemonicUpdated = phraseChanged;
  ...
  window.autoGenerateMnemonic = generateClicked;
  ...
  function populateCustomMnemonic(words) {
    if (!hasStrongRandom()) {
      var errorText = "This browser does not support strong randomness";
      showValidationError(errorText);
      return;
  ...
  window.populateCustomMnemonic = populateCustomMnemonic;
  ...
  function populateNetworkSelect() {
    for (var i = 0; i < networks.length; i++) {
      ...
      if (network.name == "BTC - Bitcoin Testnet") {
